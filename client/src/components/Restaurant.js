...
class Restaurant extends React.Component {
    ...
    renderDailyAction(daily){
        ...
        return daily.map((food) => {
            ...
            return (
                <div className="food">
                    <h3> {food.name}<span className="food-price"> {food.weight}g/{food.price}e</span></h3>
    ...
    render(){
        ...
        const {name, capacity, wifi, smoking, photoUrl,daily} = this.state.restaurant;
                ...
                <div className="row content">
                    ...
                    <div className="col span-1-of-3 box">
                        ...
                        <div className="restaurant-info">
                            <div className="title"><p>Free space</p> <p className="value">0/{capacity}</p></div>

                            <div className="title"><p>WIFI</p> <p className="value">{wifi}</p></div>
                            <div className="title"><p>Smoking</p> <p className="value">{smoking}</p></div>
                        </div>
                    ...
                    <div className="col span-1-of-3 box">
                        ...
                        <h2>Map</h2>
                        <p>
                            Location: (soon will be here)
                        </p>
                        <a className="btn btn-ghost" href="/campgrounds"> RESERVE</a>
                    </div>
                </div>
